...
export IMAGE_URL=${IMAGE_URL-quay.io/cuipinghuo_org/rhtap-python-test :$CI_TYPE-$TAG}
...
export GITOPS_REPO_URL=https://github.com/rhtap-installer/python-test-gitops
